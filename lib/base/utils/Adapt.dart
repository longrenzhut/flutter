...
class Adapt {
  ...
  Adapt._() {
    ...
    assert(
    window != null,
    '\nYou need to explicitly call the `WidgetsFlutterBinding.ensureInitialized()`, before initializing Adapt.',
    );
  ...
  factory Adapt() {
    assert(
    _instance != null,
    '\nEnsure to initialize Adapt before accessing it.',
    );
    return _instance;
  }
  ...
  num setW(num width) => width * scaleWidth;
  ...
  num setH(num height) => height * scaleHeight;
  ...
  static double setTextSp(num fontSize){
    return _instance.setSp(fontSize);
  }

  static double setWidth(num fontSize){
   return _instance.setW(fontSize);
  }

  static num setHeight(num fontSize){
    return _instance.setH(fontSize);
  }

  static getStaBarH()=>  setHeight(_instance.statusBarHeight);
}